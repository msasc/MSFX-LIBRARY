...
/**
 * Implementation of the frame functionality. Uses a {@link PaneCombo} to layout components.
 * <p>
...
public class Frame {
	 ...
	 * Constructor.
	 */
	public Frame() { this(new Stage()); }
	/**
	 * Constructor.
	 * @param stage   The source stage.
	 */
	public Frame(Stage stage) { this(stage, 5); }
	/**
	 * Constructor.
	 * @param stage   The source stage.
	 * @param padding Default padding, starting with button bar. Default is 5.
	 */
	public Frame(Stage stage, double padding) {
		this.stage = stage;
